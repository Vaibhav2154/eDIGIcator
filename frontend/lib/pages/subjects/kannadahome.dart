...
class KannadaHome extends ConsumerWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              getTranslatedText(
                ref,
                'Welcome to the Kannada Syllabus Section!',
                'ಕನ್ನಡ ಸಿಲಬಸ್ ವಿಭಾಗಕ್ಕೆ ಸ್ವಾಗತ!',
              ),
            ...
            Expanded(
              child: Center(
                child: Text(
                  getTranslatedText(
                    ref,
                    'This section contains the syllabus for Kannada.',
                    'ಈ ವಿಭಾಗದಲ್ಲಿ ಕನ್ನಡ ಸಿಲಬಸ್ ಇರುತ್ತದೆ.',
                  ),
