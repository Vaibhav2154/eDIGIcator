...
class ScienceHome extends ConsumerWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              getTranslatedText(
                ref,
                'Welcome to the Science Syllabus Section!',
                'ವಿಜ್ಞಾನ ಸಿಲಬಸ್ ವಿಭಾಗಕ್ಕೆ ಸ್ವಾಗತ!',
              ),
            ...
            Expanded(
              child: Center(
                child: Text(
                  getTranslatedText(
                    ref,
                    'This section contains the syllabus for Science.',
                    'ಈ ವಿಭಾಗದಲ್ಲಿ ವಿಜ್ಞಾನ ಸಿಲಬಸ್ ಇರುತ್ತದೆ.',
                  ),
